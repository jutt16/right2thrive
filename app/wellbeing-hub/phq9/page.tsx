...
export default function PHQ9Assessment() {
  ...
  // therapist selection (same behavior as your GAD7)
  ...
  useEffect(() => {
    ...
    if (storedTherapist?.id) {
      ...
      // Preload therapist details
      fetchTherapistDetails(String(storedTherapist.id));
    }
  }, [router]);

  // Fetch therapist list only if NOT locked (same as GAD7)
  useEffect(() => {
    if (isTherapistLocked) return;
  ...
  // Fetch standard PHQ-9 questions by default (same pattern as GAD7)
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <CardContent>
                <p className="text-gray-600">
                  This version contains the standard PHQ-9 questions used for
            ...
            {/* Specific Therapist Questions (PHQ-9) */}
            <Card className="border-2 border-teal-100">
              <CardHeader>
                ...
                <CardDescription>
                  Complete the PHQ-9 assessment with questions tailored by your
                  therapist
                </CardDescription>
              </CardHeader>
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      setIsLoading(true);
                      const response = await fetch(
                        `${process.env.NEXT_PUBLIC_API_URL}/api/questions/phq9?therapist_id=${selectedTherapist}`
                      );
                      const data = await response.json();

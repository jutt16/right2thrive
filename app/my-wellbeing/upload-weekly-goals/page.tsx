...
export default function UploadWeeklyGoals() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-blue-100 px-4">
      <div className="w-full max-w-3xl bg-white shadow-xl rounded-2xl border border-yellow-400 p-6">
        {/* Header */}
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-blue-900 mb-1">My Weekly Goals</h2>
            <p className="text-sm text-gray-700">
              <span className="font-semibold">Instructions:</span> Write down your goals
              for the week. Use the last column to note how things went, what you enjoyed,
        ...
        {selectedTherapistObj && (
          <div className="mb-6 p-4 border border-blue-200 rounded-lg bg-blue-50 text-sm text-gray-700 grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <table className="min-w-full border border-gray-200 rounded-md">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="border-b border-gray-200 px-3 py-2 text-left text-sm font-semibold text-gray-700">
                  How Did It Go? <span className="font-normal">(What I learned, tried, or enjoyed)</span>
                </th>
              </tr>
            </thead>
            <tbody>
                  ...
                  <tr key={row.number} className="align-top">
                    ...
                    <td className="border-t border-gray-200 px-3 py-2">
                      <textarea
                        ...
                        className="w-full resize-y rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                        value={row.goal}
        ...
        {/* Weekly Reflection */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-blue-900 mb-2">Weekly Reflection</h3>
          <ul className="list-disc ml-5 text-gray-800 mb-2">
            <li className="font-medium">What was the best part of my week?</li>
          </ul>
          <textarea
            rows={4}
            placeholder="Write your answer here!"
        ...
        <button
          ...
          className="w-full bg-blue-500 hover:bg-blue-600 disabled:opacity-60 disabled:cursor-not-allowed text-white font-medium py-2 rounded flex justify-center items-center space-x-2 transition"
        >
